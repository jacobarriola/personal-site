...
5. You have to learn about the payment gateway SDK
...
10. Authentication - how can you ensure that authenticated user's orders get associated with their account?
...
💡 Read my detailed implementation about <Link to="/post/hosted-woocommerce-checkout">offloading checkout to WordPress</Link>.
...
5. Authentication will work (kind of)
...
2. Unless you're using cookie authentictation, your users will have to log in again
3. The page may be slow to load, especially on mobile, since its WordPress
...
- <Link to="/post/hosted-woocommerce-checkout">
