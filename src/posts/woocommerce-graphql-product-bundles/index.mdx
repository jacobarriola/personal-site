...
In my query, I'd like to be able to return the actual items that are part of the product bundle. In WooCommerce-land, these are known as `bundleItems`. This is still a work-in-progress.

## Conclusion

Still more work here, but hopefully this will get you started. There's still plenty to be done, such as:

1. [add bundle items](/post/graphql-woocommerce-connection-product-bundles)
2. add bundle to the cart
3. more that I haven't thought of 🤷🏽‍♂️
